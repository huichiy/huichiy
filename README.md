...
| 🧠 [OS Multiplayer Game](https://github.com/huichiy/OS_Project) | Multiplayer Mega Tic-Tac-Toe using Unix sockets, threads, shared memory & concurrent logging | C |
| 🌱 Data Science Project | Sustainable energy data analysis and visualization | Python · Jupyter |
...
![Ollama](https://img.shields.io/badge/Local_AI_Models-000000?style=flat-square&logo=ollama&logoColor=white)
![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white)
![AI Workflows](https://img.shields.io/badge/AI_Dev_Workflows-CC785C?style=flat-square&logo=anthropic&logoColor=white)

---

<div align="center">

*"Building practical tools at the intersection of data, automation, and music."*
